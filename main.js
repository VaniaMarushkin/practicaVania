...
document.getElementById("open-button1").onclick = function(){
  ...
  document.getElementById("button1-4").style.display="block"
...
document.getElementById("close-button1").onclick = function(){
  ...
  document.getElementById("button1-4").style.display="none"

}
document.getElementById("open-button2").onclick = function(){
  document.getElementById("open-button2").style.display="none"
  document.getElementById("close-button2").style.display="block"
  document.getElementById("button2-1").style.display="block"
  document.getElementById("button2-2").style.display="block"
  document.getElementById("button2-3").style.display="block"
}
document.getElementById("close-button2").onclick = function(){
  document.getElementById("close-button2").style.display="none"
  document.getElementById("open-button2").style.display="block"
  document.getElementById("button2-1").style.display="none"
  document.getElementById("button2-2").style.display="none"
  document.getElementById("button2-3").style.display="none"
}
...
document.getElementById("button2-3").onclick = function(){
  document.getElementById("shop1").style.display="none"
  document.getElementById("shop2").style.display="none"
